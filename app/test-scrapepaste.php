...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
	<div id="Content" class="container">
		<a class="navbar-brand" href="https://brian-fitzgerald.net/mayflower-ancestors/index.html">Mayflower Ancestors Project</a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button> 
...
<!-- 
 ...
 -->
   <li class="nav-item">
 <button id="KitButton" class="btn btn-secondary active"><span class="spinner-grow spinner-grow-sm"></span>Table of Kits</button> 
 </li>
 <li class="nav-item">
 			<button id="CloudButton" class="btn btn-secondary">Cloud of Most Frequent Names</button> 
 </li>
  <li class="nav-item">
 			<button id="TableButton" class="btn btn-secondary">Table of Most Frequent Names</button> 
 </li>

				<li class="nav-item"> <!-- <a class="nav-link" href="https://www.buymeacoffee.com/brianfit">About</a> -->
				<button id="CoffeeButton" class="btn btn-secondary">About</button>
            ...
            <li class="nav-item">
            <button id="ContactButton" class="btn btn-secondary">
            Contact</button>
            </li>
			</ul>
		</div>
...
<!--     Content loads in this space -->
			<table id="KitMatches" class="table table-striped table-bordered">
				<thead>
					<tr>
						<th scope="col">Kit</th>
...
<script type="text/javascript">
	...
	var API_KEY = 'AIzaSyDAReMTbN6W4ydEFOrVGSYZCACgFuBVp6Y';
	  ...
	  var KitButtton = document.getElementById('KitButtton');
	  var CoffeeButton = document.getElementById('CoffeeButton');
	  var GoodPaste = true;
...
<script>
	...
	window.open('https://www.buymeacoffee.com/brianfit');
	});
	document.getElementById("KitButton").addEventListener("click", function(){
					wordcloud.style.display = 'none';
					HeatMapTable.style.display = 'none';
					KitMatches.style.display = 'block';
	});
   ...
   document.getElementById("ContactButton").addEventListener("click", function(){
	window.open('https://brian-fitzgerald.net/mayflower-ancestors/contact');
	});		
	...
	if (document.readyState !== "complete") { 
	   ...
	   console.log(document.readyState+' ELSE');
		KitButton.className.replace("spinner-grow spinner-grow-sm", "");
	} 
}; 
